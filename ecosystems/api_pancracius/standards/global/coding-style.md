...
- **Formatação Automatizada**: Manter estilo de código consistente (indentação, quebras de linha, etc.)
...
- **Compatibilidade Retroativa Apenas Quando Necessário**: A menos que especificamente instruído, assumir que não é necessário escrever lógica adicional de código para lidar com compatibilidade retroativa
